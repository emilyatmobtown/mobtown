<?php
/** 	
 *	Summary. Template for Single Post
 *	
 * 	Description. Outputs layout and content for single post
 *
 *	@package mobtown
 *	@since 1.0.0 
 */	
...
<?php while (have_posts()) : the_post(); ?>
		...
		<?php } ?>
			...
			<h2 class="mob-single-blog-title"><?php echo esc_html( get_the_title( $id ) ) ?></h2>
			<?php } ?>
			...
			<!-- Edited parent theme single.php to add mobtown icon -->
