<?php 
/** 	
 *	Summary. Template for header area.
 *	
 * 	Description. Outputs layout and content for header of all posts/pages.
 *
 *	@package mobtown
 *	@since 1.0.0 
 */	

global $eltd_options, $eltdIconCollections, $wp_query; 
...
<?php do_action( 'mob_after_body_open_tag' ); ?>
					...
					<div class="container">
						...
						<?php if($eltd_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
							...
							<div class="header_inner_left">
								...
								<h1 class="mob-offscreen">Mixing and Mastering: Mobtown Studios</h1>
									...
									<div class="header_inner_right">
										<div class="side_menu_button_wrapper right">
											...
											<div class="side_menu_button">
												...
												<!-- Moved Side Area button to left of search button -ELS -->
												<?php if($enable_side_area == "yes" && $enable_popup_menu == 'no'){ ?>
													<a class="side_menu_button_link <?php echo esc_attr($header_button_size); ?>" href="javascript:void(0)">
													<?php echo eltd_get_side_menu_icon_html(); ?></a>
												<?php } ?>
